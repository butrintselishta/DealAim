var card = function(r) {
    ...
    r.exports = function() {
        ...
        return r.toString = function() {
            ...
            for (var a = {}, n = 0; n < this.length; n++) { var o = this[n][0]; "number" == typeof o && (a[o] = !0) }
            for (n = 0; n < e.length; n++) { var i = e[n]; "number" == typeof i[0] && a[i[0]] || (t && !i[2] ? i[2] = t : t && (i[2] = "(" + i[2] + ") and (" + t + ")"), r.push(i)) }
        }, r
    }
}, function(r, e) {
    var t = {},
        a = function(r) { var e; return function() { return void 0 === e && (e = r.apply(this, arguments)), e } },
        n = a((function() { return /msie [6-9]\b/.test(self.navigator.userAgent.toLowerCase()) })),
        o = a((function() { return document.head || document.getElementsByTagName("head")[0] })),
        i = null,
        d = 0,
        c = [];
    ...
    function p(r, e) {
        for (var a = 0; a < r.length; a++) {
            var n = r[a],
                o = t[n.id];
            if (o) { o.refs++; for (var i = 0; i < o.parts.length; i++) o.parts[i](n.parts[i]); for (; i < n.parts.length; i++) o.parts.push(u(n.parts[i], e)) } else {
                var d = [];
    ...
    function g(r) { var e = document.createElement("style"); return e.type = "text/css", s(r, e), e }
    ...
    var b, j = (b = [], function(r, e) { return b[r] = e, b.filter(Boolean).join("\n") });
    ...
    var a = t(10),
        ...
        d = function(r, e, t) { o && "__proto__" === e ? o(r, e, { enumerable: !0, configurable: !0, value: t, writable: !0 }) : r[e] = t },
        c = function(r, e) { if ("__proto__" === e) { if (!n(r, e)) return; if (i) return i(r, e).value } return r[e] };
    ...
    var c = function(r) { return r != r },
        p = { boolean: 1, number: 1, string: 1, undefined: 1 },
        l = /^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{4}|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)$/,
        s = /^[A-Fa-f0-9]+$/,
        f = {};
    f.a = f.type = function(r, e) { return typeof r === e }, f.defined = function(r) { return void 0 !== r }, f.empty = function(r) {
        var e, t = d.call(r);
    ...
    r.exports = function(r) {
        ...
        for (var t, i = n.call(arguments, 1), d = function() { if (this instanceof t) { var a = e.apply(this, i.concat(n.call(arguments))); return Object(a) === a ? a : this } return e.apply(r, i.concat(n.call(arguments))) }, c = Math.max(0, e.length - i.length), p = [], l = 0; l < c; l++) p.push("$" + l);
