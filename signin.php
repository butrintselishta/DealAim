	...
	if(isset($_POST['new_password'])){
		...
		if($passError ){
			...
			if($new_pass == 0){
				...
				echo "<script language='javascript'> alert('Fjalekalimi u modifikua me sukses.'); window.location='signin.php';</script>";
			}
		}
...
<main class="bg_gray">
	...
	else
	{
		...
		if($hourdiff >= 1 ){
			...
			if($decrypted_user !== NULL && $row_token_pw['type'] == false)
			{
				?>
