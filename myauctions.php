    ...
    if(isset($_POST['btn_add_prod'])){
        ...
        if($cat_exist == true){
            if($_POST['auc_category'] == "Laptop"){
                ...
                if($titleError || $priceError || $startError || $endError || $descError || $photo1Error || $photo2Error || $photo3Error || $photo4Error || $photo5Error || $lapManError || $lapModError || $lapModError || $lapConError || $lapDisError || $lapColError || $lapProcError || $lapRamError || $lapIntMemError || $lapIntMemSpaceError || $lapGrapError || $telManError){
                ...
                $phone_mod = $_POST['phone_model'];
                $phone_con = $_POST['phone_condition'];
                $phone_col = $_POST['phone_color'];
                ...
                $phone_origin = $_POST['phone_origin_of_production'];
                ...
                if($titleError || $priceError || $startError || $endError || $descError || $photo1Error || $photo2Error || $photo3Error || $photo4Error || $photo5Error || $phoneManError || $phoneModError || $phoneConError || $phoneColError || $phoneOsError || $lapColError || $phoneRamError || $phoneIntMemSpaceError || $phoneSimError || $lapIntMemSpaceError || $phoneOriginError){
                    header("location:myauctions.php"); die();
                }
                else{
                    if (is_uploaded_file($_FILES['auc_photo1']['tmp_name'])) {
