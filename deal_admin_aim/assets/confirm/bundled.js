 ...
 * Sticky js
 */
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery"], a) } else { if (typeof module === "object" && module.exports) { module.exports = a(require("jquery")) } else { a(jQuery) } } }(function(g) {
    var i = Array.prototype.slice;
    var d = Array.prototype.splice;
    var f = { topSpacing: 0, bottomSpacing: 0, className: "is-sticky", wrapperClassName: "sticky-wrapper", center: false, getWidthFrom: "", widthFromWrapper: true, responsiveWidth: false },
        b = g(window),
        e = g(document),
        k = [],
        a = b.height(),
            ...
            for (var r = 0, p = k.length; r < p; r++) {
                ...
                if (m <= t) {
                    if (x.currentTop !== null) {
                        x.stickyElement.css({ width: "", position: "", top: "" });
                    ...
                    if (u < 0) { u = u + x.topSpacing } else { u = x.topSpacing }
                    if (x.currentTop !== u) {
                        var q;
                        if (x.getWidthFrom) { q = g(x.getWidthFrom).width() || null } else { if (x.widthFromWrapper) { q = x.stickyWrapper.width() } }
                        if (q == null) { q = x.stickyElement.width() }
                        x.stickyElement.css("width", q).css("position", "fixed").css("top", u);
                        x.stickyElement.parent().addClass(x.className);
                        if (x.currentTop === null) { x.stickyElement.trigger("sticky-start", [x]) } else { x.stickyElement.trigger("sticky-update", [x]) }
                        if (x.currentTop === x.topSpacing && x.currentTop > u || x.currentTop === null && u < x.topSpacing) { x.stickyElement.trigger("sticky-bottom-reached", [x]) } else { if (x.currentTop !== null && u === x.topSpacing && x.currentTop < u) { x.stickyElement.trigger("sticky-bottom-unreached", [x]) } }
                        x.currentTop = u
                    }
                }
            }
        ...
        c = {
            init: function(l) {
                ...
                return this.each(function() {
                    ...
                    o.wrapAll(s);
                    var q = o.parent();
                    if (m.center) { q.css({ width: o.outerWidth(), marginLeft: "auto", marginRight: "auto" }) }
            ...
            unstick: function(l) {
                return this.each(function() {
                    ...
                    if (m !== -1) {
                        n.unwrap();
                        n.css({ width: "", position: "", top: "", "float": "" })
                    }
                })
            }
        };
